...
<div class="page-wrapper">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        ...
                                                                        <ul class="menu">
                                                                            ...
                                                                            <li class="active"><a href="page-contact-2.html"><i class="fa fa-angle-right"></i>Contact 2</a></li>
    ...
    <!-- banner start -->
    <!-- ================ -->
    <div class="banner dark-translucent-bg" style="background-image:url('<?php echo base_url("panel/uploads/settings_v/space.jpg")?>'); background-position: 50% 30%;">
        <!-- breadcrumb start -->
        <!-- ================ -->
        <div class="breadcrumb-container">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Page Contact 2</li>
                </ol>
            </div>
        </div>
        <!-- breadcrumb end -->
            ...
            <div class="row justify-content-lg-center">
                <div class="col-lg-8 text-center pv-20">
                    ...
                    <ul class="list-inline mb-20 text-center">
                        <li class="list-inline-item"><i class="text-default fa fa-map-marker pr-2"></i>One infinity loop, 54100</li>
                        <li class="list-inline-item"><a href="tel:+00 1234567890" class="link-dark"><i class="text-default fa fa-phone pl-10 pr-2"></i>+00 1234567890</a></li>
                        <li class="list-inline-item"><a href="mailto:info@theproject.com" class="link-dark"><i class="text-default fa fa-envelope-o pl-10 pr-2"></i>info@theproject.com</a></li>
                    </ul>
                    <div class="separator"></div>
