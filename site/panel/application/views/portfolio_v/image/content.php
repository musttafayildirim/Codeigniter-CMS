        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <?php if (isAllowedAddModule($this->router->fetch_class())): ?>
                    <form data-url="<?php echo base_url("portfolio/refresh_image_list/$item->id"); ?>" action="<?php echo base_url("portfolio/image_upload/$item->id") ?>" id="dropzone" class="dropzone dz-clickable" data-plugin="dropzone" data-options="{ url: '<?php echo base_url("portfolio/image_upload/$item->id"); ?>'}">
