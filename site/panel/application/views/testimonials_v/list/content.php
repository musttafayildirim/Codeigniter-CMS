        ...
        <div class="widget">
            <header class="widget-header">
                <h4 class="widget-title">
                    Ziyaretçi Notları Listesi
                    <?php if(isAllowedAddModule($this->router->fetch_class())): ?>
                        <a href="<?php echo base_url("testimonials/new_testimonial"); ?>" class="btn btn-info pull-right btn-xs"><i class="fa fa-plus"></i> Yeni Ekle</a>
                    <?php endif;?>
                </h4>
            ...
            <div class="widget-body">
                <?php if (empty($items)) { ?>
                    <div class="alert alert-info alert-dismissible text-center">
                        <p>Burada herhangi bir kayıt bulunamadı.
                            <?php if(isAllowedAddModule($this->router->fetch_class())): ?>
                                Eklemek için lütfen <a href="<?php echo base_url("testimonials/new_testimonial"); ?>">tıklayınız.</a>
                            <?php else:?>
                ...
                <div class="table-responsive content-container">
                    <table class="table table-bordered table-hover table-condensed">
                        ...
                        <tbody class="<?php echo (isAllowedUpdateModule($this->router->fetch_class())) ? "sortable" : ""?> text-center" data-url="<?php echo base_url("testimonials/rankSetter");?>">
                        ...
                        <tr id="ord-<?php echo $item->id; ?>">
                            ...
                            <td class="text-center" style="width: 75px">
                                    <img
                                            src="<?php echo get_image($viewFolder, $item->img_url, "90x90"); ?>"
                            ...
                            <?php if(isAllowedDeleteModule($this->router->fetch_class()) || isAllowedUpdateModule($this->router->fetch_class())): ?>
                                <td class="w150">
                                    ...
                                    <?php if(isAllowedUpdateModule($this->router->fetch_class())): ?>
                                        <a href="<?php echo base_url("testimonials/update_testimonial/$item->id"); ?>" class="btn btn-info mw-xs"><i class="fa fa-pencil-square-o"></i></a>
                                    <?php endif;?>
                                </td>
                            <?php endif;?>
                        </tr>
