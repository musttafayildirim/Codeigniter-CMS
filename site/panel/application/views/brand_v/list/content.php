        ...
        <div class="widget">
            <header class="widget-header">
                <h4 class="widget-title">
                    Markalar Listesi
                    <a href="<?php echo base_url("brand/new_brand"); ?>" class="btn btn-info pull-right btn-xs"><i class="fa fa-plus"></i> Yeni Ekle </a>
                </h4>
            ...
            <div class="widget-body">
                ...
                <div class="alert alert-info alert-dismissible text-center">
                    <p>Burada herhangi bir kayıt bulunamadı. Eklemek için lütfen <a href="<?php echo base_url("brand/new_brand"); ?>">tıklayınız.</a></p>
                </div>
                        <?php } else { ?>
